...
For extension host debugging (`F5`), use the included `.vscode/launch.json`.
...
- set a real `repository.url`
- set proper `publisher`
- choose and add a real license file (`LICENSE`, `LICENSE.md`, or `LICENSE.txt`)
- add extension icon/assets if needed
